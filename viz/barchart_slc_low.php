...
$output = fopen('../dat/barchart_slc_low.csv', 'w');
...
//For each bed count in Salt Lake county, find the lowest bed price
...
fclose($output);
echo "<h1> \n";
echo "Lowest Prices per bedroom in Salt Lake County <br> <br>";
echo "</h1>";
?>
...
<script>
    ...
    d3.csv("../dat/barchart_slc_low.csv", function(error, data) {
