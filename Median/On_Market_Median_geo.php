...
$query = "INSERT INTO listings_geo_median 
SELECT 'id',t1.geo_id, avg(t1.listprice) as median_val, now() FROM (
SELECT @rownum:=@rownum+1 as `row_number`, d.listprice,d.geo_id
  FROM staging_table d,  (SELECT @rownum:=0) r
  WHERE d.geo_id='$data[0]'
