...
<div id="listIds">
        <div class="starClass" id="1"><img  src="images/listhouse.jpg"><br></div>
        ...
        <div class="starClass" id="2"><img  src="images/listing2.png"><br></div>
        <strong> Your Review About the House</strong>
        <form action="success_review.php" method="post">
        ...
        <div class="starClass" id="3"><img  src="images/listing3.jpg"></br></div>
        <strong> Your Review About the House</strong>
        <form action="success_review.php" method="post">
